...
var apiEnd = "&exclude=minutely,hourly,alerts&appid=30fa30050d644d0e4f6499f508876a92";
var apiBegin = "https://api.openweathermap.org/data/3.0/onecall?&lat=";
...
var apiKey = "&limit=5&appid=30fa30050d644d0e4f6499f508876a92";
    ...
    fetch(apiUrl).then(function(response){
        if(response.ok) {
            ...
            response.json().then(function(data){
                ...
                currTempEl.textContent=data.current.temp+"°K";
    ...
    fetch(apiUrl).then(function(response){
        if(response.ok) {
            ...
            response.json().then(function(data){
                ...
                temp1El.textContent=data.daily[0].temp.max+"°K";
                temp2El.textContent=data.daily[1].temp.max+"°K";
                temp3El.textContent=data.daily[2].temp.max+"°K";
                temp4El.textContent=data.daily[3].temp.max+"°K";
                temp5El.textContent=data.daily[4].temp.max+"°K";
                //display wind speed
